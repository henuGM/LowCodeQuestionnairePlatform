...
import { Typography, Spin, Table, Pagination, Space, Button } from "antd";
...
const PageStat: FC<PropsType> = (props: PropsType) => {
  ...
  // useEffect(()=>{
  //   console.log(setSelectedComponentType)
  // },[setSelectedComponentType])
